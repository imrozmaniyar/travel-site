...
/***/ function(module, exports, __webpack_require__) {
	...
	new _RevealOnScroll2.default((0, _jquery2.default)(".featured_item"), "85%");
				...
				this.iteamsToReveal.each(function () {
					...
					new Waypoint({
						...
						handler: function handler() {
							(0, _jquery2.default)(currentItem).addClass("reveal-item__is_visible");
						},
					...
					new Waypoint({
						...
						handler: function handler(direction) {
							if (direction == "down") {
								...
								(0, _jquery2.default)(matchingHeaderLink).addClass("is_current_link");
							}
						},
						offset: "18%"
					});
